...
━━━━━━━━━━ 压制后分发 ━━━━━━━━━━
✅ 功能说明:
压制成功后，自动将成品复制或移动到目标路径。
配合 WebDAV/SMB/网盘挂载磁盘，可实现：
压制完成 → 自动上传到 NAS/云端。
...
• WEBM: 网页播放
• MXF: 专业后期
• M2/M2TS: MPEG-2 及蓝光封装
• M4V: Apple 视频
• 自定义: 配合“自定义后缀名”输入框，输出任意格式
...
""",
    ...
    "音视频抽取": """
在线文档: https://github.com/xueayi/XiaoXue-Video-Tools/wiki/Features-Audio-Video-Tools

【音视频抽取】从视频中分离音频和/或视频轨道
...
您可以灵活控制文件重新编号的顺序：
• 排序方式: 按文件名 (默认) 或按大小。
• 排序方向: 升序 (1, 2, 3...) 或降序 (...3, 2, 1)。
• 关键词提前: 包含该词的文件排在最前面。
  ※ 场景：在一堆素材中，想让“封面.jpg”排在第一。
...
""",
    ...
    "媒体元数据检测": """
在线文档: https://github.com/xueayi/XiaoXue-Video-Tools/wiki/Features-Media-Probe

【媒体元数据检测】探测视频/音频/图片的详细流信息
...
1. 先用本功能查看文件有哪些流
2. 记下需要保留的音轨/字幕编号
3. 在「视频压制」或「封装转换」中填写编号

⚠️ 流编号从 #0 开始
⚠️ 与「素材质量检测」的区别：本功能侧重信息展示，QC 侧重兼容性检测
""",
}
